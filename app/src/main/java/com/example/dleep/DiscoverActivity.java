...
public class DiscoverActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.homefootbar) {
            Intent moveIntent = new Intent(DiscoverActivity.this, com.example.dleep.MainActivity.class);
            startActivity(moveIntent);
        } else if (id == R.id.discoverfootbar) {
            Intent moveIntent = new Intent(DiscoverActivity.this, com.example.dleep.DiscoverActivity.class);
            startActivity(moveIntent);
        } else if (id == R.id.alarmfootbar) {
            Intent moveIntent = new Intent(DiscoverActivity.this, com.example.dleep.discvStoriesUnplayedActivity.class);
            startActivity(moveIntent);
        } else if (id == R.id.profilefootbar) {
            Intent moveIntent = new Intent(DiscoverActivity.this, com.example.dleep.ProfileActivity.class);
            startActivity(moveIntent);
